...
add_parameter(
    PARAMETERS["valid"],
    {
        "input": {"group": "bar", "options": ["--foo"]},
        "default": {"bar.foo": None},
        "parameter": {
            "bar.foo": {"environment_prefix": "NOSETESTS", "group": "bar", "options": ["--foo"], "type": str}
        },
        "group": "bar",
    },
)
...
add_parameter(
    PARAMETERS["valid"],
    {
        "input": {"group": "under_score", "options": ["--group"]},
        "default": {"under_score.group": None},
        "parameter": {
            "under_score.group": {
...
add_parameter(
    PARAMETERS["valid"],
    {
        "input": {"group": "default", "options": ["--baz"], "action": "store_true", "help": "assistance is futile"},
        "default": {"default.baz": False},
        "parameter": {
            "default.baz": {
                "environment_prefix": "NOSETESTS",
                "group": "default",
...
add_parameter(
    PARAMETERS["valid"],
    {
        "input": {"options": ["--qux", "-q"], "default": "foo", "help": "assistance is futile"},
        "default": {"default.qux": "foo"},
        "parameter": {
            "default.qux": {
                "environment_prefix": "NOSETESTS",
                "group": "default",
...
add_parameter(
    PARAMETERS["valid"],
    {
        "input": {"options": ["foobar"], "nargs": "*", "help": "assistance is futile"},
        "default": {"default.foobar": None},
        "parameter": {
            "default.foobar": {
                "environment_prefix": "NOSETESTS",
                "group": "default",
...
add_parameter(
    PARAMETERS["valid"],
    {
        "input": {"options": ["--foobaz"], "dest": "quxbaz"},
        "default": {"default.quxbaz": None},
        "parameter": {
            "default.quxbaz": {
                "environment_prefix": "NOSETESTS",
                "group": "default",
...
add_parameter(
    PARAMETERS["valid"],
    {
        "input": {"options": ["--environment-only"], "only": ["environment"]},
        "default": {"default.environment_only": None},
        "parameter": {
...
add_parameter(
    PARAMETERS["valid"],
    {
        "input": {"options": ["--prefixed-environment"], "only": ["environment"], "environment_prefix": "crumbs"},
        "default": {"default.prefixed_environment": None},
        "parameter": {
